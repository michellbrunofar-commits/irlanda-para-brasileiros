...
GANCHO: [a mesma notícia do TITULO, reescrita pra gerar curiosidade genuína e impacto forte num story do Instagram — pode e deve ser chamativo (contraste, pergunta, número chocante, tensão), mas o impacto vem da PRECISÃO do fato real, nunca de exagero ou de termo vago. Se o fato envolve uma regra ou mudança legal, nomeie a condição real (ex.: "só se o inquilino sair por vontade própria") em vez de uma palavra vaga tipo "brecha" — isso deixa o gancho mais forte, não mais fraco, porque cria uma pergunta concreta em vez de uma acusação genérica. Não é o TITULO reformulado com mais adjetivo, é uma forma diferente de abrir a mesma informação. 100% sustentado pelo fato real — a pessoa lê o story e o texto completo bate exatamente com o que foi prometido, sem decepção. Máximo 90 caracteres. Exemplo real: "Seu aluguel pode virar preço de mercado — mas só numa condição bem específica da lei"]
...
- TESTE DO MECANISMO: quando a notícia envolver mudança de lei, regulamento ou política (reforma de aluguel, novo imposto, nova regra de visto etc.), descreva o mecanismo real e a condição exata em que ele se aplica, em vez de um termo vago tipo "brecha", "esquema" ou "brecha na lei" — mesmo que a regra seja controversa ou beneficie desproporcionalmente um lado, ela é pública e legal, não uma falha escondida sendo explorada. Só use "brecha"/"lacuna" se a notícia citada afirmar explicitamente que é uma prática irregular, não-intencional pelo legislador, ou sob investigação/contestação como abusiva — e nesse caso, atribua a alegação à fonte ("segundo [veículo/autoridade]"), não como fato direto
